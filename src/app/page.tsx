...
export default async function Home() {
  const [customers, dashboard, catalog, commercial] = await Promise.all([listCustomerSummaries(), getDashboardData(), getCatalogData(), getCommercialData()]);
  return <NevalApp initialCustomers={customers ?? []} dashboard={dashboard} catalog={catalog} commercial={commercial} />;
}
