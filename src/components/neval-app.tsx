...
import { adjustProductStock, createPurchaseOrder, createSupplier } from "@/app/actions/inventory";
...
function InventoryView({ section, inventory, onSupplier }: { section: "Compras" | "Almacén"; inventory: InventoryData | null; onSupplier: () => void }) {
